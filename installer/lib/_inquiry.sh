...
get_seed_admin_email() {
  print_banner
  printf "${WHITE} 💻 Informe o e-mail do administrador inicial:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " seed_admin_email
}

get_seed_admin_password() {
  print_banner
  printf "${WHITE} 💻 Informe uma senha forte para o administrador inicial:${GRAY_LIGHT}"
  printf "\n\n"
  read -s -p "> " seed_admin_password
  printf "\n"
}
