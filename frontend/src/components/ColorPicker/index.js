...
const ColorPicker = ({ onChange, currentColor, handleClose, open }) => {
  ...
  return <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open}><BlockPicker width={"100%"} triangle="hide" color={selectedColor} colors={colors} onChange={handleChange} onChangeComplete={color => onChange(color.hex)} /></Dialog>;
};
